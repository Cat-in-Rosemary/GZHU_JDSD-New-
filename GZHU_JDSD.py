...
key =  'MXJgaRWegOTGNf89dcaCVpCREetqiOKQrkWx+ACwvD4nRCHXryTrGS1s2N3XtBms/'
...
def vs():
    ...
    for i in range(10):
        ...
        answer = get_answer(question_num[i], game_key)
        post_answer(question_num[i], answer, game_key)
    post_timeout(game_key)
...
def post_answer(num, answer, game_key):
    post_answer_data={
        'route':'ascertain_answer',
        'key':key,
        'gaming_key':game_key,
